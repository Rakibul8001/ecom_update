...
@section('content')
    ...
    <div class="row">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <select class="form-control sismoo-selectpicker" name="ROUTE" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <select class="form-control sismoo-selectpicker" name="LANGUAGE" required>
        ...
        <div class="col-lg-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6">{{translate('SMSinBD Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('update_credentials') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('API_KEY')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="MIM_API_KEY" value="{{  env('MIM_API_KEY') }}" placeholder="API_KEY" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="SENDER_ID">
                            <div class="col-lg-3">
                                <label class="col-from-label">{{translate('SENDER_ID')}}</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" class="form-control" name="MIM_SENDER_ID" value="{{  env('MIM_SENDER_ID') }}" placeholder="SENDER_ID" required>
                            </div>
                        </div>
                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
