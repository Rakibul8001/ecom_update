            ...
            <div class="card-body">
                <form action="{{ route('affiliate.store') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <select class="form-control sismoo-selectpicker" name="amount_type">
                        ...
                        @foreach (\App\Category::all() as $key => $category)
                            ...
                            @if ($found)
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <select class="form-control sismoo-selectpicker" name="commison_types_{{ $value->category_id }}">
                            ...
                            @else
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <select class="form-control sismoo-selectpicker" name="commison_types_{{ $category->id }}">
