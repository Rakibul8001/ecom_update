            ...
            <div class="col-md">
                <div class="row gutters-5 mb-3">
                    ...
                    <div class="col-md-3 col-6">
                        <select name="poscategory" class="form-control form-control-lg sismoo-selectpicker" data-live-search="true" onchange="filterProducts()">
                    ...
                    <div class="col-md-3 col-6">
                        <select name="brand"  class="form-control form-control-lg sismoo-selectpicker" data-live-search="true" onchange="filterProducts()">
                ...
                <div class="sismoo-pos-product-list c-scrollbar-light">
                    ...
                    <div class="card-body">
                        <div class="d-flex border-bottom pb-3">
                            <div class="flex-grow-1">
                                <select name="user_id" class="form-control sismoo-selectpicker pos-customer" data-live-search="true" onchange="getShippingAddress()">
                        ...
                        <div class="" id="cart-details">
                            <div class="sismoo-pos-cart-list mb-4 mt-3 c-scrollbar-light">
                                @php
                                    $subtotal = 0;
                                    $tax = 0;
                                @endphp
                                        ...
                                        <li class="list-group-item py-0 pl-2">
                                            <div class="row gutters-5 align-items-center">
                                                <div class="col-auto w-60px">
                                                    <div class="row no-gutters align-items-center flex-column sismoo-plus-minus">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class=" row">
                                ...
                                <div class="col-sm-10">
                                    <select name="country" id="country" class="form-control sismoo-selectpicker" required data-placeholder="{{translate('Select country')}}">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $('#product-list').on('click','.add-plus:not(.c-not-allowed)',function(){
                ...
                $.post('{{ route('pos.addToCart') }}',{_token:SISMOO.data.csrf, stock_id:stock_id}, function(data){
                    if(data.success == 1){
                        updateCart(data.view);
                    }else{
                        SISMOO.plugins.notify('danger', data.message);
                    }
        ...
        function removeFromCart(key){
            $.post('{{ route('pos.removeFromCart') }}', {_token:SISMOO.data.csrf, key:key}, function(data){
                updateCart(data);
            });
        }

        function addToCart(product_id, variant, quantity){
            $.post('{{ route('pos.addToCart') }}',{_token:SISMOO.data.csrf, product_id:product_id, variant:variant, quantity, quantity}, function(data){
                $('#cart-details').html(data);
        ...
        function updateQuantity(key){
            $.post('{{ route('pos.updateQuantity') }}',{_token:SISMOO.data.csrf, key:key, quantity: $('#qty-'+key).val()}, function(data){
                if(data.success == 1){
                    updateCart(data.view);
                }else{
                    SISMOO.plugins.notify('danger', data.message);
        ...
        function setDiscount(){
            ...
            $.post('{{ route('pos.setDiscount') }}',{_token:SISMOO.data.csrf, discount:discount}, function(data){
                updateCart(data);
            });
        }
        ...
        function setShipping(){
            ...
            $.post('{{ route('pos.setShipping') }}',{_token:SISMOO.data.csrf, shipping:shipping}, function(data){
                updateCart(data);
            });
        }

        function getShippingAddress(){
            $.post('{{ route('pos.getShippingAddress') }}',{_token:SISMOO.data.csrf, id:$('select[name=user_id]').val()}, function(data){
        ...
        function orderConfirmation(){
            ...
            $.post('{{ route('pos.getOrderSummary') }}',{_token:SISMOO.data.csrf}, function(data){
        ...
        function submitOrder(payment_type){
            ...
            $.post('{{ route('pos.order_place') }}',{
                ...
                if(data.success == 1){
                    SISMOO.plugins.notify('success', data.message );
                    location.reload();
                }
                else{
                    SISMOO.plugins.notify('danger', data.message );
