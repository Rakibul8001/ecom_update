          ...
          @csrf
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control sismoo-selectpicker" name="type" id="type" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <textarea class="sismoo-text-editor" name="description">@php echo $manual_payment_method->description @endphp</textarea>
                    </div>
                </div>
