...
<div class="product-choose-list">
    <div class="product-choose">
        <div class="form-group row">
            ...
            <div class="col-lg-9">
                <select name="product_ids[]" class="form-control product_id sismoo-selectpicker" data-live-search="true" data-selected-text-format="count" required multiple>
...
<div class="form-group row">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control sismoo-date-range" value="{{ $start_date .' - '. $end_date }}" name="date_range" placeholder="Select Date">
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('.sismoo-date-range').daterangepicker();
