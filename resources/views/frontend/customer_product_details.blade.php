                        ...
                        <div class="sticky-top z-3 row gutters-10">
                            @if($customer_product->photos != null)
                                ...
                                <div class="col-12 col-md-auto w-md-80px order-2 order-md-1 mt-3 mt-md-0">
                                    <div class="sismoo-carousel product-gallery-thumb" data-items='5' data-nav-for='.product-gallery' data-vertical='true' data-vertical-sm='false' data-focus-select='true'>
                                        @foreach ($photos as $key => $photo)
    ...
    <section class="mb-4">
        <div class="container">
           <div class="bg-white shadow-sm rounded">
                ...
                <div class="p-3">
                    <div class="sismoo-carousel gutters-5 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='true'>
                        @php
