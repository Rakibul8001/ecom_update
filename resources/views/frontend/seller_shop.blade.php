...
@section('content')
    ...
    @if (!isset($type))
        ...
        <section class="mb-4">
            <div class="container">
                ...
                <div class="row">
                    <div class="col">
                        <div class="sismoo-carousel gutters-10" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-autoplay='true' data-infinute="true" data-dots="true">
    ...
    <section class="mb-4">
        <div class="container">
            ...
            <div class="sismoo-pagination sismoo-pagination-center mb-4">
                {{ $products->links() }}
            </div>
        </div>
    </section>
