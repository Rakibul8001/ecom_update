        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <select class="form-control sismoo-selectpicker" data-placeholder="{{ translate('Select a Category')}}" id="categories" name="category_id" data-live-search="true" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <select class="form-control sismoo-selectpicker" data-placeholder="{{ translate('Select a brand')}}" data-live-search="true"  id="brands" name="brand_id">
                            <option value=""></option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <input type="text" class="form-control sismoo-tag-input" name="tags[]" placeholder="{{ translate('Type & hit enter')}}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <select class="form-control sismoo-selectpicker" data-minimum-results-for-search="Infinity" name="video_provider">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <div class="mb-3">
                            <textarea class="sismoo-text-editor" name="description" required></textarea>
                        </div>
                    </div>
                </div>
            </div>
