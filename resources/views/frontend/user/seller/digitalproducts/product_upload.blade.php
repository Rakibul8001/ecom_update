        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row" id="category">
                    ...
                    <div class="col-lg-9">
                        <select class="form-control sismoo-selectpicker" name="category_id" id="category_id" required>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control sismoo-tag-input" name="tags[]" placeholder="{{ translate('Type and hit enter') }}">
