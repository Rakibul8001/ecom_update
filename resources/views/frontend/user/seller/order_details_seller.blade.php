...
<div class="modal-body gry-bg px-3 pt-0">
    {{-- <div class="py-4">
        <div class="row gutters-5 text-center sismoo-steps">
    ...
    <div class="row mt-5">
        @if($order->payment_type == 'cash_on_delivery')
            <div class="offset-lg-2 col-lg-4 col-sm-6">
                <div class="form-group">
                    <select class="form-control sismoo-selectpicker form-control-sm"  data-minimum-results-for-search="Infinity" id="update_payment_status">
        ...
        <div class="col-lg-4 col-sm-6">
            <div class="form-group">
                <select class="form-control sismoo-selectpicker form-control-sm"  data-minimum-results-for-search="Infinity" id="update_delivery_status">
...
<script type="text/javascript">
    $('#update_delivery_status').on('change', function(){
        ...
        $.post('{{ route('orders.update_delivery_status') }}', {_token:'{{ @csrf_token() }}',order_id:order_id,status:status}, function(data){
            ...
            SISMOO.plugins.notify('success', '{{ translate('Order status has been updated') }}');
