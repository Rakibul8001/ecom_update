            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control sismoo-tag-input" name="tags[]"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select class="form-control sismoo-selectpicker" data-live-search="true" name="colors[]"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select name="choice_attributes[]" id="choice_attributes"
                                class="form-control sismoo-selectpicker" data-live-search="true"
