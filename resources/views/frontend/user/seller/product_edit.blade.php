            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row" id="category">
                        ...
                        <div class="col-lg-8">
                            <select class="form-control sismoo-selectpicker" name="category_id" id="category_id"
                    ...
                    <div class="form-group row" id="brand">
                        ...
                        <div class="col-lg-8">
                            <select class="form-control sismoo-selectpicker" name="brand_id" id="brand_id">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input type="text" class="form-control sismoo-tag-input" name="tags[]" id="tags"
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <select class="form-control sismoo-selectpicker" data-live-search="true"
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <select name="choice_attributes[]" data-live-search="true" data-selected-text-format="count"
                        id="choice_attributes" class="form-control sismoo-selectpicker" multiple
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="form-group row">
                ...
                <div class="col-lg-9">
                    <textarea class="sismoo-text-editor"
