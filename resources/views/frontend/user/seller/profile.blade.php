        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-9">
                    <label class="sismoo-switch sismoo-switch-success mb-3">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <div class="mb-3">
                                    <select class="form-control sismoo-selectpicker" data-live-search="true" data-placeholder="{{ translate('Select your country')}}" name="country" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control mb-3 sismoo-selectpicker" data-live-search="true" name="city" required>
    ...
    <script type="text/javascript">
        ...
        $('.new-email-verification').on('click', function() {
            ...
            $.post('{{ route('user.new.verify') }}', {_token:'{{ csrf_token() }}', email: email}, function(data){
                ...
                if(data.status == 2)
                    SISMOO.plugins.notify('warning', data.message);
