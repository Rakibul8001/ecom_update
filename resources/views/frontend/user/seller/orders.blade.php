          ...
          <div class="card-header row gutters-5">
            <div class="col text-center text-md-left">
              ...
              <div class="col-md-3 ml-auto">
                  <select class="form-control sismoo-selectpicker" data-placeholder="{{ translate('Filter by Payment Status')}}" name="payment_status" onchange="sort_orders()">
              ...
              <div class="col-md-3 ml-auto">
                <select class="form-control sismoo-selectpicker" data-placeholder="{{ translate('Filter by Payment Status')}}" name="delivery_status" onchange="sort_orders()">
...
@section('script')
    <script type="text/javascript">
        ...
        function show_order_details(order_id)
        {
            ...
            $.post('{{ route('orders.details') }}', { _token : SISMOO.data.csrf, order_id : order_id}, function(data){
