                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control sismoo-selectpicker" data-live-search="true" name="country">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group has-feedback">
                                            ...
                                            <select class="form-control sismoo-selectpicker" data-live-search="true" name="city" required>
                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                <select class="form-control mb-3 sismoo-selectpicker" data-live-search="true" name="country" required>
