    ...
    <script type="text/javascript">
        ...
        function use_wallet(){
            ...
            if($('#agree_checkbox').is(":checked")){
                ...
                SISMOO.plugins.notify('danger','{{ translate('You need to agree with our policies') }}');
            }
        }
        ...
        $(document).on("click", "#coupon-apply",function() {
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    SISMOO.plugins.notify(data.response_message.response, data.response_message.message);
