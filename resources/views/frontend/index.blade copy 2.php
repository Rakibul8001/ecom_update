                ...
                <div class="col-lg-3 order-3 mt-3 mt-lg-0">
                    <div class="bg-white rounded shadow-sm">
                        {{-- <div class="bg-primary rounded-top p-3 d-flex align-items-center justify-content-center">
                            ...
                            <span class="badge badge-primary badge-inline"></span>
                        </div> --}}
                        <div class="c-scrollbar-light overflow-auto h-lg-400px bg-primary rounded-bottom">
                            <div class="gutters-5 lg-no-gutters row row-cols-2 row-cols-lg-1">
                                @php $banner_1_imags = json_decode(get_setting('home_banner1_images')); @endphp
                                @foreach ($banner_1_imags as $key => $value)
                                <div class="col mb-2">
                                    <a href="{{ json_decode(get_setting('home_banner1_links'), true)[$key] }}" class="d-block text-reset bg-white h-100 rounded">
                                        <div class="row gutters-5 align-items-center">
                                            <div class="col-xxl">
                                                <div class="img">
                                                    <img
                                                        class="lazyload img-fit h-140px h-lg-80px" style="border-radius: 5px"
                                                        src="{{ static_asset('assets/img/placeholder-rect.jpg') }}" data-src="{{ uploaded_asset($banner_1_imags[$key]) }}"
                                                        alt="name"
