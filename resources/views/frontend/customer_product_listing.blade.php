                        ...
                        <div class="sismoo-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035">
                            ...
                            <div class="collapse-sidebar c-scrollbar-light text-left">
                                <div class="d-flex d-xl-none justify-content-between align-items-center pl-3 border-bottom">
                                    ...
                                    <button type="button" class="btn btn-sm p-2 filter-sidebar-thumb" data-toggle="class-toggle" data-target=".sismoo-filter-sidebar" type="button">
                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="text-left">
                            <div class="d-flex">
                                <div class="form-group w-200px">
                                    ...
                                    <select class="form-control form-control-sm sismoo-selectpicker" name="sort_by" onchange="filter()">
                                ...
                                <div class="form-group ml-auto mr-0 w-200px d-none d-md-block">
                                    ...
                                    <select class="form-control form-control-sm sismoo-selectpicker" name="condition" onchange="filter()">
                                ...
                                <div class="form-group ml-2 mr-0 w-200px d-none d-md-block">
                                    ...
                                    <select class="form-control form-control-sm sismoo-selectpicker" data-live-search="true" name="brand" onchange="filter()">
                        ...
                        <div class="row gutters-5 row-cols-xxl-4 row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-2">
                            @foreach ($customer_products as $key => $product)
                                <div class="col mb-2">
                                    <div class="sismoo-card-box border border-light rounded shadow-sm hov-shadow-md h-100 has-transition bg-white">
