<div class="sismoo-category-menu bg-white rounded @if(Route::currentRouteName() == 'home') shadow-sm" @else shadow-lg" id="category-sidebar" @endif>
    <div class="p-3  d-none d-lg-block rounded-top all-category position-relative text-left text-white" style="background-color: #ff5e00">
