<form action="{{ route('commission-log.index') }}" method="GET">
    <div class="card-header row gutters-5">
        ...
        <div class="col-md-3 ml-auto">
            <select id="demo-ease" class="form-control form-control-sm sismoo-selectpicker mb-2 mb-md-0" name="seller_id">
        ...
        <div class="col-md-3">
            <div class="form-group mb-0">
                <input type="text" class="form-control form-control-sm sismoo-date-range" id="search" name="date_range"@isset($date_range) value="{{ $date_range }}" @endisset placeholder="{{ translate('Daterange') }}">
            </div>
        </div>
        <div class="col-md-2">
...
<div class="card-body">
    ...
    <div class="sismoo-pagination mt-4">
