    ...
    <form class="" id="sort_sellers" action="" method="GET">
        <div class="card-header row gutters-5">
            ...
            <div class="col-md-3 ml-auto">
                <select class="form-control sismoo-selectpicker" name="approved_status" id="approved_status" onchange="sort_sellers()">
    ...
    <script type="text/javascript">
        ...
        function update_approved(el){
            ...
            $.post('{{ route('sellers.approved') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    SISMOO.plugins.notify('success', '{{ translate('Approved sellers updated successfully') }}');
                }
                else{
