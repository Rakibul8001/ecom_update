    ...
    <form class="" id="sort_products" action="" method="GET">
        <div class="card-header row gutters-5">
            ...
            <div class="col-md-2 ml-auto">
                <select class="form-control form-control-sm sismoo-selectpicker mb-2 mb-md-0" id="user_id" name="user_id" onchange="sort_products()">
            ...
            @endif
            <div class="col-md-2 ml-auto">
                <select class="form-control form-control-sm sismoo-selectpicker mb-2 mb-md-0" name="type" id="type" onchange="sort_products()">
                    ...
                    <tr>
                        <th>
                            <div class="form-group">
                                <div class="sismoo-checkbox-inline">
    ...
    <script type="text/javascript">
        ...
        function update_todays_deal(el){
            ...
            $.post('{{ route('products.todays_deal') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    SISMOO.plugins.notify('success', '{{ translate('Todays Deal updated successfully') }}');
                }
                else{
        ...
        function update_published(el){
            ...
            $.post('{{ route('products.published') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    SISMOO.plugins.notify('success', '{{ translate('Published products updated successfully') }}');
                }
                else{
                    SISMOO.plugins.notify('danger', '{{ translate('Something went wrong') }}');
                }
        ...
        function update_approved(el){
            ...
            $.post('{{ route('products.approved') }}', {
                ...
                if(data == 1){
                    SISMOO.plugins.notify('success', '{{ translate('Product approval update successfully') }}');
                }
                else{
                    SISMOO.plugins.notify('danger', '{{ translate('Something went wrong') }}');
                }
        ...
        function update_featured(el){
            ...
            $.post('{{ route('products.featured') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    SISMOO.plugins.notify('success', '{{ translate('Featured products updated successfully') }}');
                }
                else{
                    SISMOO.plugins.notify('danger', '{{ translate('Something went wrong') }}');
                }
