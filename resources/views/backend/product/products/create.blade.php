                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control sismoo-tag-input" name="tags[]" placeholder="{{ translate('Type and hit enter to add a tag') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row gutters-5">
                            ...
                            <div class="col-md-8">
                                <select name="choice_attributes[]" id="choice_attributes" class="form-control sismoo-selectpicker" data-selected-text-format="count" data-live-search="true" multiple data-placeholder="{{ translate('Choose Attributes') }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
	                        ...
	                        <div class="col-sm-9">
	                          <input type="text" class="form-control sismoo-date-range" name="date_range" placeholder="{{translate('Select Date')}}" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off">
	                        </div>
	                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <select class="form-control sismoo-selectpicker" name="discount_type">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="sismoouploader" data-type="document">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
                                    </div>
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control sismoo-selectpicker" name="flash_deal_id" id="flash_deal">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control sismoo-selectpicker" name="flash_discount_type" id="flash_discount_type">
