                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control sismoo-selectpicker" name="category_id" id="category_id" data-selected="{{ $product->category_id }}" data-live-search="true" required>
                        ...
                        <div class="form-group row" id="brand">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control sismoo-selectpicker" name="brand_id" id="brand_id" data-live-search="true">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control sismoo-tag-input" name="tags[]" id="tags" value="{{ $product->tags }}" placeholder="{{ translate('Type to add a tag') }}" data-role="tagsinput">
                            </div>
                        </div>
                        @php
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <label class="sismoo-switch sismoo-switch-success mb-0" style="margin-top:5px;">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control sismoo-selectpicker" name="video_provider" id="video_provider">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row gutters-5">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control sismoo-selectpicker" data-live-search="true" data-selected-text-format="count" name="colors[]" id="colors" multiple>
                        ...
                        <div class="form-group row gutters-5">
                            ...
                            <div class="col-lg-8">
                                <select name="choice_attributes[]" id="choice_attributes" data-selected-text-format="count" data-live-search="true" class="form-control sismoo-selectpicker" multiple data-placeholder="{{ translate('Choose Attributes') }}">
                        ...
                        <div class="customer_choice_options" id="customer_choice_options">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <select class="form-control sismoo-selectpicker attribute_choice" data-live-search="true" name="choice_options_{{ $choice_option->attribute_id }}[]" multiple>
                                    ...
                                    {{-- <input type="text" class="form-control sismoo-tag-input" name="choice_options_{{ $choice_option->attribute_id }}[]" placeholder="{{ translate('Enter choice values') }}" value="{{ implode(',', $choice_option->values) }}" data-on-change="update_sku"> --}}
                                </div>
                            </div>
                            @endforeach
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control sismoo-date-range" value="{{ $start_date.' to '.$end_date }}" name="date_range" placeholder="{{translate('Select Date')}}" data-time-picker="true" data-format="DD-MM-Y HH:mm:ss" data-separator=" to " autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                <select class="form-control sismoo-selectpicker" name="discount_type" required>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <textarea class="sismoo-text-editor" name="description">{{ $product->getTranslation('description', $lang) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-toggle="sismoouploader">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
                                    </div>
                                    <div class="form-control file-amount">{{ translate('Choose File') }}</div>
                    ...
                    <div class="card-body">
                        ...
                        @else
                            <p>
                                ...
                                <a href="{{route('activation.index')}}" class="sismoo-side-nav-link {{ areActiveRoutes(['shipping_configuration.index','shipping_configuration.edit','shipping_configuration.update'])}}">
                                    <span class="sismoo-side-nav-text">{{translate('Cash Payment Activation')}}</span>
                                </a>
                            </p>
                        @endif
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control sismoo-selectpicker" name="flash_deal_id" id="video_provider">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control sismoo-selectpicker" name="flash_discount_type" id="">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <select class="form-control sismoo-selectpicker" name="tax_type[]">
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                <div class="form-group row">\
                    ...
                    <div class="col-md-8">\
                        <select class="form-control sismoo-selectpicker attribute_choice" data-live-search="true" name="choice_options_'+ i +'[]" multiple>\
                            '+obj+'\
                        </select>\
                    </div>\
                </div>');
