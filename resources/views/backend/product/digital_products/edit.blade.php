				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="form-group row" id="category">
							...
							<div class="col-lg-8">
								<select class="form-control sismoo-selectpicker" name="category_id" id="category_id" data-selected="{{ $product->category_id }}" required>
						...
						<div class="form-group row">
							...
							<div class="col-lg-8">
				                <div class="input-group" data-toggle="sismoouploader" data-multiple="false">
						...
						<div class="form-group row">
							...
							<div class="col-lg-8">
								<input type="text" class="form-control sismoo-tag-input" name="tags[]" id="tags" value="{{ $product->tags }}" placeholder="{{ translate('Type to add a tag') }}">
							</div>
						</div>
					</div>
				</div>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<select class="form-control sismoo-selectpicker" name="tax_type" required>
