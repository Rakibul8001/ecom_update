...
<div class="card">
    <form id="sort_uploads" action="">
        <div class="card-header row gutters-5">
            ...
            <div class="col-md-3 ml-auto mr-0">
                <select class="form-control form-control-xs sismoo-selectpicker" name="sort" onchange="sort_uploads()">
    ...
    <div class="card-body">
    		...
    		@foreach($all_uploads as $key => $file)
    			...
    			<div class="col-auto w-140px w-lg-220px">
    				<div class="sismoo-file-box">
    					...
    					<div class="card card-file sismoo-uploader-select c-default" title="{{ $file_name }}.{{ $file->extension }}">
		...
		<div class="sismoo-pagination mt-3">
...
@section('script')
	<script type="text/javascript">
		function detailsInfo(e){
			...
			$.post('{{ route('uploaded-files.info') }}', {_token: SISMOO.data.csrf, id:id}, function(data){
