<div class="sismoo-topbar px-15px px-lg-25px d-flex align-items-stretch justify-content-between">
    <div class="d-flex">
        <div class="sismoo-topbar-nav-toggler d-flex align-items-center justify-content-start mr-2 mr-md-3 ml-0" data-toggle="sismoo-mobile-nav">
            <button class="sismoo-mobile-toggler">
                <span></span>
            </button>
        </div>
        <div class="sismoo-topbar-logo-wrap d-xl-none d-flex align-items-center justify-content-start">
            @php
    ...
    <div class="d-flex justify-content-between align-items-stretch flex-grow-xl-1">
        ...
        <div class="d-flex justify-content-around align-items-center align-items-stretch">
            ...
            <div class="sismoo-topbar-item ml-2">
