...
<div class="row">
	<div class="col-xl-10 mx-auto">
		...
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Home ImageBanner 1 (Max 3)') }}</h6>
			</div>
			<div class="card-body">
				<form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="form-group">
						<label>{{ translate('ImageBanner & Links') }}</label>
		...
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Home ImageBanner 2 (Max 3)') }}</h6>
			</div>
			<div class="card-body">
				<form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
					@csrf
		...
		<div class="card">
			<div class="card-header">
				<h6 class="mb-0">{{ translate('Home ImageBanner 3 (Max 3)') }}</h6>
			</div>
			<div class="card-body">
				<form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
					@csrf
