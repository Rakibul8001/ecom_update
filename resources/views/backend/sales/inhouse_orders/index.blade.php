      ...
      <div class="card-header row gutters-5">
        ...
        <div class="col-lg-2">
          ...
          <div class="col-lg-2 ml-auto">
            <select class="form-control sismoo-selectpicker" name="payment_type" id="payment_type" onchange="sort_orders()">
          ...
          <div class="col-lg-2 ml-auto">
            <select class="form-control sismoo-selectpicker" name="delivery_status" id="delivery_status" onchange="sort_orders()">
