    ...
    <div class="card-body">
        <div class="row gutters-5">
            ...
            <div class="col-md-3 ml-auto">
                ...
                <select class="form-control sismoo-selectpicker"  data-minimum-results-for-search="Infinity" id="update_payment_status">
            ...
            <div class="col-md-3 ml-auto">
                ...
                @if($delivery_status != 'delivered' && $delivery_status != 'cancelled')
                    <select class="form-control sismoo-selectpicker"  data-minimum-results-for-search="Infinity" id="update_delivery_status">
        ...
        <div class="row">
            <div class="col-lg-12 table-responsive">
                <table class="table table-bordered sismoo-table invoice-summary">
                    <thead>
    ...
    <script type="text/javascript">
        $('#assign_deliver_boy').on('change', function(){
            ...
            $.post('{{ route('orders.delivery-boy-assign') }}', {
                ...
                SISMOO.plugins.notify('success', '{{ translate('Delivery boy has been assigned') }}');
            });
        });
        ...
        $('#update_delivery_status').on('change', function(){
            ...
            $.post('{{ route('orders.update_delivery_status') }}', {
                ...
                SISMOO.plugins.notify('success', '{{ translate('Delivery status has been updated') }}');
            });
        });
        ...
        $('#update_payment_status').on('change', function(){
            ...
            $.post('{{ route('orders.update_payment_status') }}', {_token:'{{ @csrf_token() }}',order_id:order_id,status:status}, function(data){
                SISMOO.plugins.notify('success', '{{ translate('Payment status has been updated') }}');
            });
        });
    </script>
@endsection
