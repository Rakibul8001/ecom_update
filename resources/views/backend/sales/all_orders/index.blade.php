...
<!--                    <a class="dropdown-item" href="#" data-toggle="modal" data-target="#exampleModal">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <select class="form-control sismoo-selectpicker" onchange="change_status()" data-minimum-results-for-search="Infinity" id="update_delivery_status">
            ...
            <div class="col-lg-2 ml-auto">
                <select class="form-control sismoo-selectpicker" name="delivery_status" id="delivery_status">
            ...
            <div class="col-lg-2">
                <div class="form-group mb-0">
                    <input type="text" class="sismoo-date-range form-control" value="{{ $date }}" name="date" placeholder="{{ translate('Filter by date') }}" data-format="DD-MM-Y" data-separator=" to " data-advanced-range="true" autocomplete="off">
                </div>
            </div>
            <div class="col-lg-2">
                <div class="form-group mb-0">
