...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <table class="table sismoo-table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th width="10%">#</th>
    ...
    <script type="text/javascript">
        ...
        function update_status(el){
            ...
            $.post('{{ route('countries.status') }}', {_token:'{{ csrf_token() }}', id:el.value, status:status}, function(data){
                if(data == 1){
                    SISMOO.plugins.notify('success', '{{ translate('Country status updated successfully') }}');
                }
                else{
