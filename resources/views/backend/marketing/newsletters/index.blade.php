            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{ route('newsletters.send') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control sismoo-selectpicker" name="user_emails[]" multiple data-selected-text-format="count" data-actions-box="true">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control sismoo-selectpicker" name="subscriber_emails[]" multiple data-selected-text-format="count" data-actions-box="true">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea rows="8" class="form-control sismoo-text-editor" data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]], ["insert", ["link", "picture"]],["view", ["undo","redo"]]]' name="content" required></textarea>
                        </div>
                    </div>
