...
Route::post('/sismoo-uploader', 'SismooUploadController@show_uploader');
Route::post('/sismoo-uploader/upload', 'SismooUploadController@upload');
Route::get('/sismoo-uploader/get_uploaded_files', 'SismooUploadController@get_uploaded_files');
Route::post('/sismoo-uploader/get_file_by_ids', 'SismooUploadController@get_preview_files');
Route::get('/sismoo-uploader/download/{id}', 'SismooUploadController@attachment_download')->name('download_attachment');
...
Route::group(['prefix' => 'seller', 'middleware' => ['seller', 'verified', 'user']], function() {
    ...
    //Upload
    Route::any('/uploads/', 'SismooUploadController@index')->name('my_uploads.all');
    Route::any('/uploads/new', 'SismooUploadController@create')->name('my_uploads.new');
    Route::any('/uploads/file-info', 'SismooUploadController@file_info')->name('my_uploads.info');
    Route::get('/uploads/destroy/{id}', 'SismooUploadController@destroy')->name('my_uploads.destroy');
});
