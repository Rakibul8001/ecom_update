...
Route::group(['prefix' => 'master', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::post('/business-settings/update', 'SettingsController@update')->name('settings.update');
    Route::post('/business-settings/update/activation', 'SettingsController@updateActivationSettings')->name('settings.update.activation');
    Route::get('/general-setting', 'SettingsController@general_setting')->name('general_setting.index');
    Route::get('/activation', 'SettingsController@activation')->name('activation.index');
    Route::get('/payment-method', 'SettingsController@payment_method')->name('payment_method.index');
    Route::get('/file_system', 'SettingsController@file_system')->name('file_system.index');
    Route::get('/social-login', 'SettingsController@social_login')->name('social_login.index');
    Route::get('/smtp-settings', 'SettingsController@smtp_settings')->name('smtp_settings.index');
    Route::get('/google-analytics', 'SettingsController@google_analytics')->name('google_analytics.index');
    Route::get('/google-recaptcha', 'SettingsController@google_recaptcha')->name('google_recaptcha.index');
    Route::get('/google-map', 'SettingsController@google_map')->name('google-map.index');
    Route::get('/google-firebase', 'SettingsController@google_firebase')->name('google-firebase.index');

    //Facebook Settings
    Route::get('/facebook-chat', 'SettingsController@facebook_chat')->name('facebook_chat.index');
    Route::post('/facebook_chat', 'SettingsController@facebook_chat_update')->name('facebook_chat.update');
    Route::get('/facebook-comment', 'SettingsController@facebook_comment')->name('facebook-comment');
    Route::post('/facebook-comment', 'SettingsController@facebook_comment_update')->name('facebook-comment.update');
    Route::post('/facebook_pixel', 'SettingsController@facebook_pixel_update')->name('facebook_pixel.update');

    Route::post('/env_key_update', 'SettingsController@env_key_update')->name('env_key_update.update');
    Route::post('/payment_method_update', 'SettingsController@payment_method_update')->name('payment_method.update');
    Route::post('/google_analytics', 'SettingsController@google_analytics_update')->name('google_analytics.update');
    Route::post('/google_recaptcha', 'SettingsController@google_recaptcha_update')->name('google_recaptcha.update');
    Route::post('/google-map', 'SettingsController@google_map_update')->name('google-map.update');
    Route::post('/google-firebase', 'SettingsController@google_firebase_update')->name('google-firebase.update');
    //Currency
    ...
    Route::get('/verification/form', 'SettingsController@seller_verification_form')->name('seller_verification_form.index');
    Route::post('/verification/form', 'SettingsController@seller_verification_form_update')->name('seller_verification_form.update');
    Route::get('/vendor_commission', 'SettingsController@vendor_commission')->name('settings.vendor_commission');
    Route::post('/vendor_commission_update', 'SettingsController@vendor_commission_update')->name('settings.vendor_commission.update');
    ...
    Route::get('/shipping_configuration', 'SettingsController@shipping_configuration')->name('shipping_configuration.index');
    Route::post('/shipping_configuration/update', 'SettingsController@shipping_configuration_update')->name('shipping_configuration.update');
